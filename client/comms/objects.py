...
acknowledgement_dictionary = {1000:"rca-1.2:connection_acknowledge", 1001:"rca-1.2:buffer_size_ok", 2000:"rca-1.2:buffer_size_over_spec", 2001:"rca-1.2:authentication_invalid", 2002:"rca-1.2:unknown_command"} # look up dictionary to convert numeric ID codes to readable alphabetical IDs
