...
The authentication key is a final layer of security, and may be edited. In host configurations however, you must hash the password yourself (the hash type is SHA3-512). There is a tool included to do this, labelled auth_key_hasher.py.
Please also remember to edit the hardware configuration to match what hardware your bot supports and also network configurations (i.e ports and host IP).
...
Refer to your router manual if this feature exists and how to use it.
